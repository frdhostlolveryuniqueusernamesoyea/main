...
// actual kingvon antipiracy ↓

devtoolsDetector.addListener(function (isOpen, detail) {
    if (isOpen) {
      document.getElementById('bodej').innerHTML = `<video id="kingvon" autoplay loop>
        <source src="/files/kingvon.mp4" type="video/mp4">
        Váš prohlížeč nepodporuje video tag.
        </video>`;

        var video = document.getElementById('kingvon');

        // Funkce pro přepnutí do fullscreen
        ...
        // Zavolání funkce na začátku
        video.oncanplay = goFullscreen;
